...
function(check_file_hash has_hash hash_is_good)
  ...
  message(VERBOSE "verifying file...
       file='D:/RESONANCE/build/_deps/mbedtls-tmp/mbedtls-3.6.5.tar.bz2'")

  file("SHA256" "D:/RESONANCE/build/_deps/mbedtls-tmp/mbedtls-3.6.5.tar.bz2" actual_value)
  ...
  if(NOT "${actual_value}" STREQUAL "4a11f1777bb95bf4ad96721cac945a26e04bf19f57d905f241fe77ebeddf46d8")
    ...
    D:/RESONANCE/build/_deps/mbedtls-tmp/mbedtls-3.6.5.tar.bz2
...
if(EXISTS "D:/RESONANCE/build/_deps/mbedtls-tmp/mbedtls-3.6.5.tar.bz2")
  ...
  SHA256='4a11f1777bb95bf4ad96721cac945a26e04bf19f57d905f241fe77ebeddf46d8'"
      ...
      file(REMOVE "D:/RESONANCE/build/_deps/mbedtls-tmp/mbedtls-3.6.5.tar.bz2")
    endif()
  else()
...
message(VERBOSE "Downloading...
   dst='D:/RESONANCE/build/_deps/mbedtls-tmp/mbedtls-3.6.5.tar.bz2'
   timeout='none'
...
foreach(i RANGE ${retry_number})
  ...
  foreach(url IN ITEMS [====[https://github.com/Mbed-TLS/mbedtls/releases/download/mbedtls-3.6.5/mbedtls-3.6.5.tar.bz2]====])
    if(NOT url IN_LIST skip_url_list)
      ...
      file(
        DOWNLOAD
        "${url}" "D:/RESONANCE/build/_deps/mbedtls-tmp/mbedtls-3.6.5.tar.bz2"
